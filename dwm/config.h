...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,              XK_l,          rotatestack,            {.i = -1 } },
	#endif // ROTATESTACK_PATCH
	#if INPLACEROTATE_PATCH
	{ MODKEY|Mod1Mask|ShiftMask,    XK_k,          inplacerotate,          {.i = +1} },
	{ MODKEY|Mod1Mask|ShiftMask,    XK_l,          inplacerotate,          {.i = -1} },
	#endif // INPLACEROTATE_PATCH
	#if PUSH_PATCH || PUSH_NO_MASTER_PATCH
	{ MODKEY|ControlMask,           XK_k,          pushdown,               {0} },
	{ MODKEY|ControlMask,           XK_l,          pushup,                 {0} },
	...
	{ MODKEY|ShiftMask,             XK_h,          setcfact,               {0} },
	#endif // CFACTS_PATCH
	...
	{ MODKEY|Mod1Mask,              XK_agrave,          togglegaps,             {0} },
	...
	{ MODKEY|ShiftMask,             XK_z,          togglefakefullscreen,   {0} },
	#endif // FAKEFULLSCREEN_CLIENT_PATCH
	#if FULLSCREEN_PATCH
